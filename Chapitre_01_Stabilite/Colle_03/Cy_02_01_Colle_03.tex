...
$G(p)=\dfrac{8}{p^2 + 5p + 6}$.

\subparagraph{}\textit{Tracer les diagrammes de bode de $G(p)$.}
\subparagraph{}\textit{Tracer la marge de gain et la marge de phase.}

On place ce système dans une boucle de régulation en le précédent d'un correcteur proportionnel $C(p)=K$. La boucle de retour est assurée par un système de fonction de transfert $B(p)=3$.
...
\begin{center}
\rotatebox{90}{\includegraphics[width=.5\linewidth]{images/fig_02}}
\end{center}
