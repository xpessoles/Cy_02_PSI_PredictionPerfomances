...
\subparagraph{}\textit{La réponse du système à cette entrée en échelon de tension $u_m (t) =10u(t)$ a été mesurée en sortie du réducteur. On donne ci-dessous la courbe obtenue. Déterminer les valeurs numériques expérimentales de $K_m$ et $T_m$. Réaliser les tracés utiles sur le document réponse 1.}
