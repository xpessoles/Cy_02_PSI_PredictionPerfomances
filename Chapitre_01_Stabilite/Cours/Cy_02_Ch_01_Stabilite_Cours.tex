...
Pour un système d'ordre supérieur à 3 il devient délicat d'obtenir analytiquement (ou numériquement) les racines du polynômes et ainsi conclure sur la stabilité à partir du signe des parties réelles. 
...
\begin{resultat}
Le système en boucle ouverte étant asymptotiquement stable (ou juste stable), le système en boucle fermée est asymptotiquement stable si et seulement si :
$$
