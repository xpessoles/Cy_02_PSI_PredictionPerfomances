...
%%\begin{figure}[!htb]
%\begin{center}
%\rotatebox{270}{\includegraphics[height=\linewidth]{images/image6.jpeg}}
%
%\vspace{.5cm}
%
...
%
%\begin{center}
%\includegraphics[width=1.0\linewidth]{images/image10.png}
%
...
%\includegraphics[width=1.0\linewidth,angle=90]{images/image9.png}
...
%\begin{center}
%
%\includegraphics[width=1.0\linewidth]{images/image13.png}
...
En conséquence, ${a}=\dfrac{1}{4bc\tau\xi^2}$. (On prend $\xi=0,7$ car cela correspond au temps de réponse le plus rapide pour un second ordre.)
\end{corrige}
\else
\fi
