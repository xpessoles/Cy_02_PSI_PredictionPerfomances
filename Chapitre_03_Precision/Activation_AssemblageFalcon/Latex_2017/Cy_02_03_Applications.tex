...
\def\xxfigures{
\includegraphics[width=.7\textwidth]{images/image1}
...
% 
%\begin{center}
%\includegraphics[width=4.5cm]{images/image7}
%\end{center} 
%
%
...
%
%\begin{center}
%\includegraphics[width=5cm]{images/image8}
%\end{center} 
%
%
%\fi
...
\subparagraph{}
\textit{On souhaite déterminer l'erreur en vitesse du système. Calculer l'écart pour $C(p)=\dfrac{K_i}{p}$. Pouvait-on prévoir le résultat ?}
\ifprof
\begin{corrige}
\end{corrige}
\else
